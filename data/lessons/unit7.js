...
const unit5 = {
  ...
  lessons: [
    ...
    {
      id: 'u7l5',
      title: 'Oral Torah — Mishnah, Talmud & Tradition',
      iconName: 'oral_torah_chain',
      hook: {
        title: 'The Torah That Was Never Written Down — Until It Had To Be',
        body: `<p>At Sinai, two Torahs were given: one written, one oral. For 1,200 years the Oral Torah lived only in memory — until history forced its hand.</p>`,
      },
      teachSlides: [
        {
          title: 'The Chain of Transmission',
          hebrew: 'תּוֹרָה שֶׁבְּעַל פֶּה',
          transliteration: 'Torah She\'be\'al Peh',
          translation: 'Torah That Is on the Mouth',
          body: `<p>Pirkei Avot 1:1 traces the chain: "Moshe received Torah from Sinai and transmitted it to Yehoshua; Yehoshua to the Elders; the Elders to the Prophets; and the Prophets transmitted it to the Men of the Great Assembly." This oral tradition explains how to observe the Written Torah — how long to rest on Shabbat, how to perform a brit milah, how to tie tefillin. The Written Torah without the Oral Torah is incomplete; the two were always one.</p>`,
          concept: 'Torah She\'bichtav (Written) and Torah She\'be\'al Peh (Oral) — two halves of one revelation.',
        },
        {
          title: 'Mishnah and Talmud — When Memory Became Text',
          body: `<p>After the destruction of the Second Temple (70 CE) and the dispersion, Rabbi Yehuda HaNasi feared the Oral Torah would be lost. Around 200 CE he compiled the <em>Mishnah</em> — 63 tractates of oral law organized by topic. The Mishnah then became the subject of intense analysis in the academies of Israel and Babylon. These discussions were recorded and compiled into the <em>Gemara</em>. Together — Mishnah + Gemara — they form the <em>Talmud</em>. Two Talmuds exist: the <em>Yerushalmi</em> (Jerusalem, ~400 CE) and the <em>Bavli</em> (Babylonian, ~500 CE). The Bavli became the primary source of Jewish law for virtually all communities.</p>`,
          concept: 'Writing it down did not end the conversation — it started the next one.',
        },
      ],
      questions: [
        {
          type: 'multiple_choice',
          prompt: 'Who compiled the Mishnah around 200 CE?',
          options: ['Rabbi Akiva', 'Rabbi Yehuda HaNasi', 'Rabbi Shimon bar Yochai', 'Hillel'],
          correct: 1,
          explanation: 'Rabbi Yehuda HaNasi — "the Prince" — compiled the Mishnah to preserve the Oral Torah after the Temple\'s destruction and the dispersion.',
        },
        {
          type: 'multiple_choice',
          prompt: 'The Talmud is made up of:',
          options: ['Torah and Neviim', 'Mishnah and Gemara', 'Rashi and Tosafot', 'Midrash and Haggadah'],
          correct: 1,
          explanation: 'Mishnah (compiled oral law) + Gemara (the rabbinic analysis of the Mishnah) = Talmud.',
        },
        {
          type: 'multiple_choice',
          prompt: 'According to Pirkei Avot 1:1, who received Torah first at Sinai and then transmitted it?',
          options: ['Aaron', 'Moshe', 'Yehoshua', 'The Elders'],
          correct: 1,
          explanation: 'Moshe received the Torah from Sinai and transmitted it — beginning the chain of tradition.',
        },
        {
          type: 'true_false',
          prompt: 'The Babylonian Talmud (Bavli) became the primary source of halacha for most Jewish communities.',
          correct: true,
          explanation: 'The Bavli (~500 CE) became authoritative for virtually all communities, while the Yerushalmi (~400 CE) is also studied but considered secondary for halachic decisions.',
        },
        {
          type: 'fill_blank',
          prompt: 'The Hebrew term for the Oral Torah — the Torah transmitted by word of mouth — is "Torah She\'___."',
          answer_variants: ["be'al peh", "beal peh", "b'al peh"],
          explanation: '"Torah She\'be\'al Peh" — Torah that is on the mouth. The oral dimension of the Sinaitic revelation.',
        },
        {
          type: 'typed_translation',
          prompt: 'Type the English meaning of "Mishnah".',
          answer_variants: ['repetition', 'teaching', 'oral teaching', 'that which is learned by repetition'],
          explanation: '"Mishnah" — from the root "to repeat/learn." The compiled oral law that forms the core of the Talmud.',
        },
        {
          type: 'match_pairs',
          prompt: 'Match each text to its description.',
          left: [
            { id: 'a', text: 'Mishnah' },
            { id: 'b', text: 'Gemara' },
            { id: 'c', text: 'Bavli' },
            { id: 'd', text: 'Yerushalmi' },
          ],
          right: [
            { id: '1', text: 'Jerusalem Talmud (~400 CE)' },
            { id: '2', text: 'Compiled oral law (Rabbi Yehuda HaNasi, ~200 CE)' },
            { id: '3', text: 'Babylonian Talmud — primary halachic source (~500 CE)' },
            { id: '4', text: 'Rabbinic analysis and discussion of the Mishnah' },
          ],
          correct: { a: '2', b: '4', c: '3', d: '1' },
          explanation: 'Mishnah = compiled oral law; Gemara = its analysis; Bavli = Babylonian Talmud; Yerushalmi = Jerusalem Talmud.',
        },
        {
          type: 'order_steps',
          prompt: 'Order the chain of Torah transmission as described in Pirkei Avot 1:1.',
          steps: [
            { id: 'a', text: 'Moshe at Sinai' },
            { id: 'b', text: 'Yehoshua' },
            { id: 'c', text: 'The Elders' },
            { id: 'd', text: 'The Prophets' },
            { id: 'e', text: 'Men of the Great Assembly' },
          ],
          correctOrder: ['a', 'b', 'c', 'd', 'e'],
          explanation: 'Moshe → Yehoshua → Elders → Prophets → Men of the Great Assembly — the living chain of tradition.',
        },
      ],
      wrap: {
        title: 'In summary',
        body: `<p>The Oral Torah is not a supplement to the Written Torah — it is its living breath. The Mishnah, Gemara, and Talmud are the record of how each generation received and passed on the flame.</p>`,
      },
      sources: [
        'Pirkei Avot 1:1',
        'Talmud Gittin 60b',
      ...
      readMore: `<p>The Talmud (Gittin 60b) records a halachic tension: the Oral Torah was not supposed to be written — "divrei Torah she\'be\'al peh ein lecha reshut lichtovam" — you may not write down words of Oral Torah. Yet Rabbi Yehuda HaNasi did it anyway, citing the principle "Et la\'asot l\'Hashem heiferu Toratecha" — "it is a time to act for G-d; they have nullified Your Torah" (Tehillim 119:126). The urgency of the moment — imminent forgetting — outweighed the prohibition. A lesson about when the survival of the tradition requires breaking the tradition's own rules.</p>`,
    },

    {
      ...
      hook: {
        title: 'Torah Study — Quiz',
        body: `<p>Ten questions spanning the parasha cycle, Torah reading, commentators, Oral Torah, and applying Torah to life.</p>`,
      },
      teachSlides: [],
      questions: [
        {
        ...
        {
          type: 'multiple_choice',
          prompt: 'Who compiled the Mishnah to preserve the Oral Torah?',
          options: ['Rabbi Akiva', 'Rabbi Yehuda HaNasi', 'Hillel', 'Rabbi Shimon bar Yochai'],
          correct: 1,
          explanation: 'Rabbi Yehuda HaNasi compiled the Mishnah around 200 CE.',
        },
        {
          type: 'multiple_choice',
          prompt: 'Who founded the Mussar movement?',
        ...
        {
          type: 'true_false',
          prompt: 'The Babylonian Talmud (Bavli) became the primary source of halacha for most communities.',
          correct: true,
          explanation: 'The Bavli (~500 CE) is authoritative for virtually all Jewish communities worldwide.',
        },
        {
          type: 'fill_blank',
        ...
        },
        {
          ...
          right: [
            ...
            { id: '2', text: 'Compiled Oral Law (~200 CE)' },
            { id: '3', text: 'Literal meaning' },
            { id: '4', text: 'The essential Torah commentator' },
          ],
          correct: { a: '3', b: '4', c: '2', d: '1' },
          explanation: 'Peshat = literal, Rashi = commentator, Mishnah = compiled Oral Law, Mussar = character work.',
        },
      ],
      wrap: {
        title: 'Unit Complete',
        body: `<p>You\'ve completed the Torah Study unit. The ocean of Torah is infinite; you\'ve stepped into the water. "It is not upon you to finish the work, nor are you free to desist from it" (Pirkei Avot 2:16).</p>`,
      },
      sources: [
        'Talmud Megillah 29b',
        'Pirkei Avot 1:1',
